...
private:
  ...
  void fill(cv::Mat& image, nlohmann::json data);
  void noise(cv::Mat& image, nlohmann::json data);
  void walker(cv::Mat& image, nlohmann::json data);
  void gradient(cv::Mat& image, nlohmann::json data, int page = 0);
  void rectangle(cv::Mat& image, nlohmann::json data, int page = 0);
