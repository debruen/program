...
class AreaSine {
  ...
  private:
    ...
    // const double& m_frequency,& m_phase,& m_tilt;
  ...
  public:
    ...
    // AreaSine(const std::size_t& width, const std::size_t& height, const std::size_t& frame_index, const double& m_frequency, const double& m_phase, const double& m_tilt, const std::string& shape);
